...
export default function WebPerformance() {
  ...
  useEffect(() => {
    dispatch(updateMenuTitle("웹 퍼포먼스"));
  }, []);
  ...
  return (
    <div className="WebPerformance">
      ...
      <div className="api-result">
        ...
        <div className="api-detail">
          <div className="represent">
            ...
            <div
              className="coreValue"
              onClick={() => handleChangeCoreValueDetail(FCPDetail)}
            >
            ...
            <div
              className="coreValue"
              onClick={() => handleChangeCoreValueDetail(TTIDetail)}
            >
            ...
            <div
              className="coreValue"
              onClick={() => handleChangeCoreValueDetail(SIDetail)}
            >
            ...
            <div
              className="coreValue"
              onClick={() => handleChangeCoreValueDetail(TBTDetail)}
            >
            ...
            <div
              className="coreValue"
              onClick={() => handleChangeCoreValueDetail(LCPDetail)}
            >
            ...
            <div
              className="coreValue"
              onClick={() => handleChangeCoreValueDetail(CLSDetail)}
            >
      ...
      <div>
        <button disabled={disableButton} onClick={moveToSolutions}>
          솔루션 페이지로 이동
        </button>
        <Solutions
